...
gyvenviete = Recipe(
    ...
    salis=foreign_key(salis, one_to_one=True),
)
...
pavadinimas = Recipe(
    ...
    gyvenviete=foreign_key(gyvenviete, one_to_one=True),
)
...
apskritis = Recipe(
    ...
    centras=foreign_key(gyvenviete, one_to_one=True),
...
savivaldybe = Recipe(
    ...
    dokumentai=related(dokumentas, dokumentas),
    salis=foreign_key(salis, one_to_one=True),
    apskritis=foreign_key(apskritis, one_to_one=True),
)
...
seniunija = Recipe(
    ...
    dokumentai=related(dokumentas, dokumentas),
    salis=foreign_key(salis, one_to_one=True),
    savivaldybe=foreign_key(savivaldybe, one_to_one=True),
)
